...
const DOMAINS: Domain[] = [
  {
    ...
    topics: [
      { en: 'CIA Triad', ar: 'ثلاثية السرية والسلامة والتوافر (CIA)' },
      { en: 'AAA & Zero Trust', ar: 'المصادقة والتفويض والمحاسبة (AAA) والثقة الصفرية' },
  ...
  },
  {
    ...
    icon: ShieldAlert,
    color: '#f87171',
    title: { en: 'Threats, Vulnerabilities & Mitigations', ar: 'التهديدات والثغرات وإجراءات الحد منها' },
    desc: {
    ...
    topics: [
      { en: 'Threat Actors', ar: 'جهات التهديد' },
      { en: 'Malware Types', ar: 'أنواع البرمجيات الخبيثة' },
      { en: 'Social Engineering', ar: 'الهندسة الاجتماعية' },
      { en: 'Phishing', ar: 'التصيّد' },
      { en: 'Vulnerabilities & Zero-days', ar: 'الثغرات وثغرات اليوم الصفري' },
      { en: 'Mitigation Techniques', ar: 'أساليب الحد من المخاطر' },
    ],
  },
  {
    num: '03',
  ...
  },
  {
    ...
    topics: [
      ...
      { en: 'System Hardening', ar: 'تحصين الأنظمة' },
  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 touch:min-h-tap text-xs font-semibold text-[#8592ad] hover:text-[#00a859] transition-colors select-none"
      >
