...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'dashboard.lessonsCompleted': { en: 'Lessons Completed', ar: 'الدروس المكتملة' },
  ...
  'dashboard.totalLessons': { en: 'Total Lessons', ar: 'إجمالي الدروس' },
  'dashboard.pathsStat': { en: 'Learning Paths', ar: 'مسارات التعلم' },
  'dashboard.overall': { en: 'Overall progress', ar: 'التقدّم الكلي' },
  'dashboard.contentHours': { en: 'Hours of Content', ar: 'ساعات المحتوى' },
  ...
  'dashboard.recommended': { en: 'Recommended for you', ar: 'موصى به لك' },
  'dashboard.start': { en: 'Start', ar: 'ابدأ' },
  'dashboard.continueBtn': { en: 'Continue', ar: 'متابعة' },
  'dashboard.openStudio': { en: 'Content Studio', ar: 'استوديو المحتوى' },
