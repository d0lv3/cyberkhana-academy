 ...
 */
const PathCard: React.FC<{ path: CreatorPath; index?: number }> = ({ path: p }) => {
  ...
  return (
    <ImageCard
      ...
      fallback={<CardArt kind="path" color={p.color} className="transition-transform duration-500 group-hover:scale-[1.04]" />}
      role="button"
      tabIndex={0}
      onClick={open}
      onKeyDown={(e) => {
